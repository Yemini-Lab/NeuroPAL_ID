classdef channels
    ...
    properties (Constant)
        ...
        channel_shorts = {'r', 'g', 'b', 'w', 'dic', 'gfp'};
    ...
    methods (Static, Access = public)
        ...
        function index = idx(channel)
            if nargin > 0
                index = [ ...
                    Program.Handlers.channels.idx('r') ...
                    Program.Handlers.channels.idx('g') ...
                    Program.Handlers.channels.idx('b') ...
                    Program.Handlers.channels.idx('w') ...
                    Program.Handlers.channels.idx('dic') ...
                    Program.Handlers.channels.idx('gfp')];
                return
            end

            component_name = sprintf("%sDropDown", upper(channel));
            index = str2double(app.(component_name).Value);
        end

        function bool = bool(channel)
            if nargin > 0
                bool = [ ...
                    Program.Handlers.channels.bool('r') ...
                    Program.Handlers.channels.bool('g') ...
                    Program.Handlers.channels.bool('b') ...
                    Program.Handlers.channels.bool('w') ...
                    Program.Handlers.channels.bool('dic') ...
                    Program.Handlers.channels.bool('gfp')];
                return
            end

            component_name = sprintf("%sCheckBox", upper(channel));
            bool = str2double(app.(component_name).Value);
        end
        ...
        function channel_struct = read_gui()
            red = struct( ...
                'idx', {Program.Handlers.channels.idx('r')}, ...
                'bool', {Program.Handlers.channels.bool('r')});
            
            green = struct( ...
                'idx', {Program.Handlers.channels.idx('g')}, ...
                'bool', {Program.Handlers.channels.bool('g')});

            blue = struct( ...
                'idx', {Program.Handlers.channels.idx('b')}, ...
                'bool', {Program.Handlers.channels.bool('b')});

            white = struct( ...
                'idx', {Program.Handlers.channels.idx('w')}, ...
                'bool', {Program.Handlers.channels.bool('w')});

            dic = struct( ...
                'idx', {Program.Handlers.channels.idx('dic')}, ...
                'bool', {Program.Handlers.channels.bool('dic')});

            gfp = struct( ...
                'idx', {Program.Handlers.channels.idx('gfp')}, ...
                'bool', {Program.Handlers.channels.bool('gfp')});
