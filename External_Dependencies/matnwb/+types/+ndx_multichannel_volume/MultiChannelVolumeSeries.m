...
methods
    function obj = MultiChannelVolumeSeries(varargin)
        ...
        varargin = [{'data_conversion' types.util.correctType(1, 'single') 'data_offset' types.util.correctType(0, 'single') 'data_resolution' types.util.correctType(-1, 'single') 'format' 'raw'} varargin];
